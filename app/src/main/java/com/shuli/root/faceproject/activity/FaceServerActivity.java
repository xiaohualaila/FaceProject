...
public class FaceServerActivity extends Activity implements CameraManager.CameraListener, View.OnClickListener {
...
//////////////////////////////////////////////
    ...
    private void toast(String msg) {
        Toast.makeText(FaceServerActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
...
//            beginRecogIdArrayList.add(passImage.trackId);
            ...
            try {
                sbody = new StringBody(FaceServerActivity.group_name, ContentType.TEXT_PLAIN.withCharset(CharsetUtils.get("UTF-8")));
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
